...
const CONTROLS = ['nothing', 'up', 'down', 'left', 'right'];
const CONTROL_CODES = [23333, 38, 40, 37, 39];
...
nothingButton.addEventListener('mousedown', () => handler(0));
nothingButton.addEventListener('mouseup', () => mouseDown = false);

upButton.addEventListener('mousedown', () => handler(1));
upButton.addEventListener('mouseup', () => mouseDown = false);

downButton.addEventListener('mousedown', () => handler(2));
downButton.addEventListener('mouseup', () => mouseDown = false);

leftButton.addEventListener('mousedown', () => handler(3));
leftButton.addEventListener('mouseup', () => mouseDown = false);

rightButton.addEventListener('mousedown', () => handler(4));
